...
function ProjectCompiler.generateClosureBundle(runtime)
    ...
    table.insert(builder, "    local math = _G.math")
    ...
    table.insert(builder, "    local compare = cast.compare")
    table.insert(builder, "    local mod = cast.mod")
    table.insert(builder, "    local random = cast.random")
    table.insert(builder, "    local listGet = cast.listGet")
    table.insert(builder, "    local listContains = cast.listContains")
    table.insert(builder, "    local listIndexOf = cast.listIndexOf")
    table.insert(builder, "    local listContents = cast.listContents")
    table.insert(builder, "    local toListIndex = cast.toListIndex")
    table.insert(builder, "    local letterOf = cast.letterOf")
    table.insert(builder, "    local length = cast.length")
    table.insert(builder, "    local join = cast.join")
    table.insert(builder, "    local contains = cast.contains")
    table.insert(builder, "    local toScratchDisplayString = cast.toScratchDisplayString")
    table.insert(builder, "    local LIST_INVALID = cast.LIST_INVALID")
    table.insert(builder, "    local LIST_ALL = cast.LIST_ALL")
    table.insert(builder, "    local LIST_ITEM_LIMIT = cast.LIST_ITEM_LIMIT")
